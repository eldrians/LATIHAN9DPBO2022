...
from tkinter import *
hunians = []
hunians.append(Apartemen("Saul Goodman", 3, 3, 65, 1000))
hunians.append(Rumah("Gustavo Fring", 5, 2, 200, 2250))
hunians.append(Indekos("Chuck McGill", "Howard Hamlin", 35, 500))
hunians.append(Rumah("Mike Ehrmantraut", 1, 4, 120, 1500))
root = Tk()
